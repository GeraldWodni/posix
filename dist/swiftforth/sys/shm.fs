...
\ ------===< functions >===-------
FUNCTION: shmctl ( __shmid __cmd __buf -- n )	( __shmid __cmd __buf -- )
FUNCTION: shmget ( __key __size __shmflg -- n )	( __key __size __shmflg -- )
FUNCTION: shmat ( __shmid __shmaddr __shmflg -- a )	( __shmid __shmaddr __shmflg -- )
FUNCTION: shmdt ( __shmaddr -- n )	( __shmaddr -- )
