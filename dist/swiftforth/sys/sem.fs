...
\ ------===< functions >===-------
FUNCTION: semctl ( __semid __semnum __cmd  -- n )	( __semid __semnum __cmd <noname> -- )
FUNCTION: semget ( __key __nsems __semflg -- n )	( __key __nsems __semflg -- )
FUNCTION: semop ( __semid __sops __nsops -- n )	( __semid __sops __nsops -- )
