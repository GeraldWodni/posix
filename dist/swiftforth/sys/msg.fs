...
\ ------===< functions >===-------
FUNCTION: msgctl ( __msqid __cmd __buf -- n )	( __msqid __cmd __buf -- )
FUNCTION: msgget ( __key __msgflg -- n )	( __key __msgflg -- )
FUNCTION: msgrcv ( __msqid __msgp __msgsz __msgtyp __msgflg -- n )	( __msqid __msgp __msgsz __msgtyp __msgflg -- )
FUNCTION: msgsnd ( __msqid __msgp __msgsz __msgflg -- n )	( __msqid __msgp __msgsz __msgflg -- )
