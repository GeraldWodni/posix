...
\ ------===< functions >===-------
FUNCTION: ntohl ( __netlong -- n )	( __netlong -- )
FUNCTION: ntohs ( __netshort -- n )	( __netshort -- )
FUNCTION: htonl ( __hostlong -- n )	( __hostlong -- )
FUNCTION: htons ( __hostshort -- n )	( __hostshort -- )
