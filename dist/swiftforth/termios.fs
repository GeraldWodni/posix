...
\ ------===< functions >===-------
FUNCTION: cfgetospeed ( __termios_p -- u )	( __termios_p -- )
FUNCTION: cfgetispeed ( __termios_p -- u )	( __termios_p -- )
FUNCTION: cfsetospeed ( __termios_p __speed -- n )	( __termios_p __speed -- )
FUNCTION: cfsetispeed ( __termios_p __speed -- n )	( __termios_p __speed -- )
FUNCTION: tcgetattr ( __fd __termios_p -- n )	( __fd __termios_p -- )
FUNCTION: tcsetattr ( __fd __optional_actions __termios_p -- n )	( __fd __optional_actions __termios_p -- )
FUNCTION: tcsendbreak ( __fd __duration -- n )	( __fd __duration -- )
