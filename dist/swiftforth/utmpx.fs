...
\ ------===< functions >===-------
FUNCTION: setutxent (  -- void )	( -- )
FUNCTION: endutxent (  -- void )	( -- )
FUNCTION: getutxent (  -- a )	( -- )
FUNCTION: getutxid ( __id -- a )	( __id -- )
FUNCTION: getutxline ( __line -- a )	( __line -- )
FUNCTION: pututxline ( __utmpx -- a )	( __utmpx -- )
