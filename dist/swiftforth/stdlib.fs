...
FUNCTION: posix_memalign ( __memptr __alignment __size -- n )	( __memptr __alignment __size -- )
FUNCTION: abort (  -- void )	( -- )
...
FUNCTION: setenv ( __name __value __replace -- n )	( __name __value __replace -- )
FUNCTION: unsetenv ( __name -- n )	( __name -- )
FUNCTION: mkstemp ( __template -- n )	( __template -- )
FUNCTION: mkdtemp ( __template -- a )	( __template -- )
...
FUNCTION: getsubopt ( __optionp __tokens __valuep -- n )	( __optionp __tokens __valuep -- )
