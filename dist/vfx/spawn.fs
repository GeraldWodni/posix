...
EXTERN: "C" int posix_spawnattr_setpgroup( void * __attr, long __pgroup );	( __attr __pgroup -- )
...
EXTERN: "C" int posix_spawn_file_actions_addopen( void * __file_actions, int __fd, char * __path, int __oflag, long __mode );	( __file_actions __fd __path __oflag __mode -- )
