...
EXTERN: "C" int wcsncasecmp( char * __s1, char * __s2, n __n );	( __s1 __s2 __n -- )
EXTERN: "C" int wcscasecmp_l( char * __s1, char * __s2, n __loc );	( __s1 __s2 __loc -- )
EXTERN: "C" int wcsncasecmp_l( char * __s1, char * __s2, n __n, n __loc );	( __s1 __s2 __n __loc -- )
EXTERN: "C" int wcscoll( char * __s1, char * __s2 );	( __s1 __s2 -- )
EXTERN: "C" n wcsxfrm( void * __s1, char * __s2, n __n );	( __s1 __s2 __n -- )
EXTERN: "C" int wcscoll_l( char * __s1, char * __s2, n __loc );	( __s1 __s2 __loc -- )
EXTERN: "C" n wcsxfrm_l( void * __s1, char * __s2, n __n, n __loc );	( __s1 __s2 __n __loc -- )
...
EXTERN: "C" n wcsnlen( char * __s, n __maxlen );	( __s __maxlen -- )
...
EXTERN: "C" n mbsnrtowcs( void * __dst, void * __src, n __nmc, n __len, void * __ps );	( __dst __src __nmc __len __ps -- )
EXTERN: "C" n wcsnrtombs( void * __dst, void * __src, n __nwc, n __len, void * __ps );	( __dst __src __nwc __len __ps -- )
...
EXTERN: "C" void * wcpncpy( void * __dest, char * __src, n __n );	( __dest __src __n -- )
