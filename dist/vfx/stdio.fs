...
EXTERN: "C" int vdprintf( int __fd, char * __fmt, n __arg );	( __fd __fmt __arg -- )
...
EXTERN: "C" int fseeko( void * __stream, n __off, int __whence );	( __stream __off __whence -- )
EXTERN: "C" n ftello( void * __stream );	( __stream -- )
