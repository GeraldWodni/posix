...
EXTERN: "C" void * fdopen( int __fd, char * __modes );	( __fd __modes -- )
EXTERN: "C" void setbuf( void * __stream, void * __buf );	( __stream __buf -- )
EXTERN: "C" int setvbuf( void * __stream, void * __buf, int __modes, long __n );	( __stream __buf __modes __n -- )
...
EXTERN: "C" int vfprintf( void * __s, char * __format, long __arg );	( __s __format __arg -- )
EXTERN: "C" int vprintf( char * __format, long __arg );	( __format __arg -- )
EXTERN: "C" int vsprintf( void * __s, char * __format, long __arg );	( __s __format __arg -- )
EXTERN: "C" int snprintf( void * __s, long __maxlen, char * __format, ...  );	( __s __maxlen __format <noname> -- )
EXTERN: "C" int vsnprintf( void * __s, long __maxlen, char * __format, long __arg );	( __s __maxlen __format __arg -- )
EXTERN: "C" int vdprintf( int __fd, char * __fmt, long __arg );	( __fd __fmt __arg -- )
EXTERN: "C" int dprintf( int __fd, char * __fmt, ...  );	( __fd __fmt <noname> -- )
...
EXTERN: "C" int vfscanf( void * __s, char * __format, long __arg );	( __s __format __arg -- )
EXTERN: "C" int vscanf( char * __format, long __arg );	( __format __arg -- )
EXTERN: "C" int vsscanf( char * __s, char * __format, long __arg );	( __s __format __arg -- )
...
EXTERN: "C" long fread( void * __ptr, long __size, long __n, void * __stream );	( __ptr __size __n __stream -- )
EXTERN: "C" long fwrite( void * __ptr, long __size, long __n, void * __s );	( __ptr __size __n __s -- )
...
EXTERN: "C" int fseeko( void * __stream, long __off, int __whence );	( __stream __off __whence -- )
EXTERN: "C" long ftello( void * __stream );	( __stream -- )
...
EXTERN: "C" int fileno( void * __stream );	( __stream -- )
EXTERN: "C" void * ctermid( void * __s );	( __s -- )
