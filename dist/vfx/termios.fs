...
\ ------===< functions >===-------
EXTERN: "C" int cfgetospeed( void * __termios_p );	( __termios_p -- )
EXTERN: "C" int cfgetispeed( void * __termios_p );	( __termios_p -- )
EXTERN: "C" int cfsetospeed( void * __termios_p, int __speed );	( __termios_p __speed -- )
EXTERN: "C" int cfsetispeed( void * __termios_p, int __speed );	( __termios_p __speed -- )
EXTERN: "C" int tcgetattr( int __fd, void * __termios_p );	( __fd __termios_p -- )
EXTERN: "C" int tcsetattr( int __fd, int __optional_actions, void * __termios_p );	( __fd __optional_actions __termios_p -- )
EXTERN: "C" int tcsendbreak( int __fd, int __duration );	( __fd __duration -- )
...
EXTERN: "C" long tcgetsid( int __fd );	( __fd -- )
