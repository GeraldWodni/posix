...
\ ------===< functions >===-------
EXTERN: "C" int glob( char * __pattern, int __flags, void * __errfunc, void * __pglob );	( __pattern __flags __errfunc __pglob -- )
EXTERN: "C" void globfree( void * __pglob );	( __pglob -- )
