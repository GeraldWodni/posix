...
\ ------===< functions >===-------
EXTERN: "C" int fmtmsg( long __classification, char * __label, int __severity, char * __text, char * __action, char * __tag );	( __classification __label __severity __text __action __tag -- )
