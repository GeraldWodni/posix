...
\ ------===< functions >===-------
EXTERN: "C" int socket( int __domain, int __type, int __protocol );	( __domain __type __protocol -- )
EXTERN: "C" int socketpair( int __domain, int __type, int __protocol, void * __fds );	( __domain __type __protocol __fds -- )
EXTERN: "C" int bind( int __fd, long __addr, long __len );	( __fd __addr __len -- )
EXTERN: "C" int getsockname( int __fd, long __addr, void * __len );	( __fd __addr __len -- )
EXTERN: "C" int connect( int __fd, long __addr, long __len );	( __fd __addr __len -- )
EXTERN: "C" int getpeername( int __fd, long __addr, void * __len );	( __fd __addr __len -- )
EXTERN: "C" long send( int __fd, void * __buf, long __n, int __flags );	( __fd __buf __n __flags -- )
EXTERN: "C" long recv( int __fd, void * __buf, long __n, int __flags );	( __fd __buf __n __flags -- )
EXTERN: "C" long sendto( int __fd, void * __buf, long __n, int __flags, long __addr, long __addr_len );	( __fd __buf __n __flags __addr __addr_len -- )
EXTERN: "C" long recvfrom( int __fd, void * __buf, long __n, int __flags, long __addr, void * __addr_len );	( __fd __buf __n __flags __addr __addr_len -- )
EXTERN: "C" long sendmsg( int __fd, void * __message, int __flags );	( __fd __message __flags -- )
EXTERN: "C" long recvmsg( int __fd, void * __message, int __flags );	( __fd __message __flags -- )
EXTERN: "C" int getsockopt( int __fd, int __level, int __optname, void * __optval, void * __optlen );	( __fd __level __optname __optval __optlen -- )
EXTERN: "C" int setsockopt( int __fd, int __level, int __optname, void * __optval, long __optlen );	( __fd __level __optname __optval __optlen -- )
EXTERN: "C" int listen( int __fd, int __n );	( __fd __n -- )
EXTERN: "C" int accept( int __fd, long __addr, void * __addr_len );	( __fd __addr __addr_len -- )
EXTERN: "C" int shutdown( int __fd, int __how );	( __fd __how -- )
EXTERN: "C" int sockatmark( int __fd );	( __fd -- )
