...
EXTERN: "C" int bind( int __fd, n __addr, n __len );	( __fd __addr __len -- )
EXTERN: "C" int getsockname( int __fd, n __addr, void * __len );	( __fd __addr __len -- )
EXTERN: "C" int connect( int __fd, n __addr, n __len );	( __fd __addr __len -- )
EXTERN: "C" int getpeername( int __fd, n __addr, void * __len );	( __fd __addr __len -- )
EXTERN: "C" n send( int __fd, void * __buf, n __n, int __flags );	( __fd __buf __n __flags -- )
EXTERN: "C" n recv( int __fd, void * __buf, n __n, int __flags );	( __fd __buf __n __flags -- )
EXTERN: "C" n sendto( int __fd, void * __buf, n __n, int __flags, n __addr, n __addr_len );	( __fd __buf __n __flags __addr __addr_len -- )
EXTERN: "C" n recvfrom( int __fd, void * __buf, n __n, int __flags, n __addr, void * __addr_len );	( __fd __buf __n __flags __addr __addr_len -- )
EXTERN: "C" n sendmsg( int __fd, void * __message, int __flags );	( __fd __message __flags -- )
EXTERN: "C" n recvmsg( int __fd, void * __message, int __flags );	( __fd __message __flags -- )
...
EXTERN: "C" int setsockopt( int __fd, int __level, int __optname, void * __optval, n __optlen );	( __fd __level __optname __optval __optlen -- )
EXTERN: "C" int listen( int __fd, int __n );	( __fd __n -- )
EXTERN: "C" int accept( int __fd, n __addr, void * __addr_len );	( __fd __addr __addr_len -- )
