...
EXTERN: "C" void openlog( char * __ident, int __option, int __facility );	( __ident __option __facility -- )
EXTERN: "C" int setlogmask( int __mask );	( __mask -- )
EXTERN: "C" void syslog( int __pri, char * __fmt, ...  );	( __pri __fmt <noname> -- )
