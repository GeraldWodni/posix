...
\ --===< function pointers >===---
c-funptr glob_t-gl_closedir() {((glob_t*)ptr)->gl_closedir} a -- void	( <noname> -- )
c-funptr glob_t-gl_readdir() {((glob_t*)ptr)->gl_readdir} a -- a	( <noname> -- )
c-funptr glob_t-gl_opendir() {((glob_t*)ptr)->gl_opendir} s -- a	( <noname> -- )
c-funptr glob_t-gl_lstat() {((glob_t*)ptr)->gl_lstat} s a -- n	( <noname> <noname> -- )
c-funptr glob_t-gl_stat() {((glob_t*)ptr)->gl_stat} s a -- n	( <noname> <noname> -- )

\ ------===< functions >===-------
c-function glob glob s n a a -- n	( __pattern __flags __errfunc __pglob -- )
c-function globfree globfree a -- void	( __pglob -- )
