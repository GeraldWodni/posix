...
\ ----===< prefix >===-----
c-library sys_resource
s" sys_resource" add-lib
...
\ ------===< functions >===-------
c-function getrlimit getrlimit n a -- n	( __resource __rlimits -- )
c-function setrlimit setrlimit n a -- n	( __resource __rlimits -- )
c-function getrusage getrusage n a -- n	( __who __usage -- )
c-function getpriority getpriority n n -- n	( __which __who -- )
c-function setpriority setpriority n n n -- n	( __which __who __prio -- )
