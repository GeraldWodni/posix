...
\ ----===< prefix >===-----
c-library sys_socket
s" sys_socket" add-lib
...
\ ------===< functions >===-------
c-function socket socket n n n -- n	( __domain __type __protocol -- )
c-function socketpair socketpair n n n a -- n	( __domain __type __protocol __fds -- )
c-function bind bind n n n -- n	( __fd __addr __len -- )
c-function getsockname getsockname n n a -- n	( __fd __addr __len -- )
c-function connect connect n n n -- n	( __fd __addr __len -- )
c-function getpeername getpeername n n a -- n	( __fd __addr __len -- )
c-function send send n a u n -- n	( __fd __buf __n __flags -- )
c-function recv recv n a u n -- n	( __fd __buf __n __flags -- )
c-function sendto sendto n a u n n n -- n	( __fd __buf __n __flags __addr __addr_len -- )
c-function recvfrom recvfrom n a u n n a -- n	( __fd __buf __n __flags __addr __addr_len -- )
c-function sendmsg sendmsg n a n -- n	( __fd __message __flags -- )
c-function recvmsg recvmsg n a n -- n	( __fd __message __flags -- )
c-function getsockopt getsockopt n n n a a -- n	( __fd __level __optname __optval __optlen -- )
c-function setsockopt setsockopt n n n a n -- n	( __fd __level __optname __optval __optlen -- )
c-function listen listen n n -- n	( __fd __n -- )
c-function accept accept n n a -- n	( __fd __addr __addr_len -- )
c-function shutdown shutdown n n -- n	( __fd __how -- )
c-function sockatmark sockatmark n -- n	( __fd -- )
