...
\ ------===< functions >===-------
c-function setutxent setutxent  -- void	( -- )
c-function endutxent endutxent  -- void	( -- )
c-function getutxent getutxent  -- a	( -- )
c-function getutxid getutxid a -- a	( __id -- )
c-function getutxline getutxline a -- a	( __line -- )
c-function pututxline pututxline a -- a	( __utmpx -- )
