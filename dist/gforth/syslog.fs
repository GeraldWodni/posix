...
\ ------===< functions >===-------
c-function closelog closelog  -- void	( -- )
c-function openlog openlog s n n -- void	( __ident __option __facility -- )
c-function setlogmask setlogmask n -- n	( __mask -- )
c-function syslog syslog n s ... -- void	( __pri __fmt <noname> -- )
