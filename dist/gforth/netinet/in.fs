...
\ ----===< prefix >===-----
c-library netinet_in
s" netinet_in" add-lib
...
\ ------===< functions >===-------
c-function ntohl ntohl n -- n	( __netlong -- )
c-function ntohs ntohs n -- n	( __netshort -- )
c-function htonl htonl n -- n	( __hostlong -- )
c-function htons htons n -- n	( __hostshort -- )
